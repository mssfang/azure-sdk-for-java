...
//        String eTag = "HFRHspwdgpY65Rnm1EuarWuL9mX-5T2q0s7k-Cmlf5g";
        ...
        String continuesToken = "/kv?api-version=2023-10-01&after=a2V5MTg4Cg%3D%3D";
        String eTag = "\"GYGNLvyzCCZwPGuZVrXpBtfQkg3r_1chdDNhpWv53WI\"";
...
//                new Context("continuesToken", continuesToken).addData("pageETag", etag));
        ...
        Response<List<ConfigurationSetting>> listResponse = client.listConfigurationSettingsForSinglePage(continuesToken,
                new MatchConditions().setIfNoneMatch(etag), null,
                Context.NONE);
        System.out.println("Status code = " + listResponse.getStatusCode());
        System.out.println("Settings:");
        for (ConfigurationSetting setting : listResponse.getValue()) {
