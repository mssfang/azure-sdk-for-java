...
public final class VolumesListGetGroupIdListForLdapUserMockTests {
    ...
    public void testListGetGroupIdListForLdapUser() throws Exception {
        String responseStr = "{\"groupIdsForLdapUser\":[\"eifzzhmk\",\"as\",\"flyh\",\"xcudchxgsr\"]}";
        ...
        GetGroupIdListForLdapUserResponse response = manager.volumes()
            .listGetGroupIdListForLdapUser("urvzmlovuanashc", "lpmjerb", "kelvidizozsdb", "cxjmonfdgnwncyp",
                new GetGroupIdListForLdapUserRequest().withUsername("uwwltvuqjctz"), com.azure.core.util.Context.NONE);

        Assertions.assertEquals("eifzzhmk", response.groupIdsForLdapUser().get(0));
    }
}
